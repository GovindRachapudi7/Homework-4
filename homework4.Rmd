...
Evidence: The data shows that there is practically no difference in gas prices between a gas station's proximity to a stop light. Gas stations at stoplights charge \$1.863 per gallon, while gas stations not at stoplights charge \$1.866.

Conclusion: The theory that gas stations at stoplights charge more is definitely incorrect because both charge the same amount of money. The difference in price between gas stations near and not near a stoplight is somewhere between \$-.0318 and \$.0385. This data can conclude that this claim is incorrect because there is not much of a difference between the gas prices. Also gas stations at stoplights charge \$1.863 per gallon, while gas stations not at stoplights charge \$1.866. In conclusion, the data shows that there is not enough of a price difference to conclude that gas stations at stoplights charge more.
...
Conclusion: According to my analysis, shell does indeed charge more than all other non-shell brands. I came to this conclusion by finding difference in price between shell and other brands which is somewhere between -0.066 and 0.0112, with 95% confidence. According to my data there is only a 2 cents difference between shell and the rest of the brands but that is enough impute that shell is charging more than all other brands on average.
